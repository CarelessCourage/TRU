...
<template>
<PaperWrapper :disablePaper="true">
  ...
  <div class="info">
    <PillBody v-if="true" :class="{marked: shift}">
      <Split :delay="0">
        ...
        <p class="bold" data-line><span class="span">In contemporary use,</span> the practice and study of 
      ...
      <Split :delay="0">
        <p data-line class="bold">
          <span class="span">Professionally,</span> Typography is the work of typesetters (also known as compositors), 
      ...
      <Split :delay="0">
        <h3 class="bold" data-slide>Your words are precious to me. They are my map to your world</h3>
        <p class="bold" data-line>
          But as Beatrice Ward put it: the most important thing about [type] 
          is that it conveys <span class="span">thought, ideas, 
    ...
    <div class="text-block" v-if="true">
      <div class="body paragraphs" :class="{marked: shift}">
        <div class="content">
          <Split :delay="0">
            <h2 data-slide>Type represents the start of human civilisation</h2>
            <h3 data-line>
              The first evidence of type is in Mesopotamia (present-day Iraq) 
              where cuneiform was used between 3400 and 3300 BC.
            </h3>
            <p data-line>
              Beatrice Ward: There is no “explanation” whatever of the fact that I can make arbitrary
              sounds that will lead a total stranger to think my own <span class="span">thought.</span> It is sheer 
              magic that I should be able to hold a one-sided conversation by means of black 
              marks on paper with an unknown person halfway across the world.
            </p>
            <p data-line>
              Talking, broadcasting, writing, and printing are all quite literally forms of 
              ...
              human <span class="span">civilization</span>
            </p>
          </Split>
        </div>
      </div>
      ...
      <div class="body paragraphs" :class="{marked: shift}">
        <div class="content">
          <Split :delay="0">
            ...
            <p data-line class="bold">
              Beatrice Ward: There is nothing <span class="span">simple or dull</span> in achieving the transparent page. Vulgar ostentation is twice as easy as 
              discipline. When you realize that ugly typography never effaces itself, you will be able to 
              capture beauty as the wise men capture happiness, by aiming at something else. 
            </p>
          </Split>
        </div>
      </div>
        ...
        <div class="content">
          <Split :delay="0">
            ...
            <p data-line class="bold">
              ...
              in devising that <span class="span">crystalline goblet</span> which is worthy to 
